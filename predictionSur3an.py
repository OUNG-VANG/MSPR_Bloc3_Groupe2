...
pred2024_df = make_predictions_for_year(2024, adjustment_factor=0.00)  # Aucun ajustement pour 2024
pred2025_df = make_predictions_for_year(2025, adjustment_factor=0.01)  # Ajustement de 1% pour simuler les changements en 2025
pred2026_df = make_predictions_for_year(2026, adjustment_factor=0.02)  # Ajustement de 2% pour simuler les changements en 2026
pred2027_df = make_predictions_for_year(2027, adjustment_factor=0.03)  # Ajustement de 3% pour simuler les changements en 2027
